export const enum MessageType {
    ...
    FetchBlobImage = "fetch-blob-image",
...
export type FetchBlobImageMessage = {
...
export type Message =
    | FetchOrRestoreImageMessage
    | StartedTranslationMessage
    | CompletedTranslationMessage
    | FailedTranslationMessage
    | FetchGroupNotTranslatedMessage
    | InspectMessage
    | FetchBlobImageMessage;
...
export type FetchBlobImageResponse = MessageResponse<string>
